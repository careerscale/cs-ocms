...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		...
		$('#example').dataTable({
			...
			sUpdateURL : "updateCaseStatus",
			sAddURL : "addCaseStatus",
			sDeleteURL : "delCaseStatus",
			sAddHttpMethod : "GET",
			...
			<div id="fw_content">
				...
				<div class="full_width">
					<form id="formAddNewRow" action="#" title="Add a new browser"
						...
						<label for="name">Case Status</label><br /> <input type="text"
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display"
						...
						<tbody id="tbody1">
							...
							<c:forEach items="${botypeList}" var="casestatus">
								<tr id='${casestatus.id}'>
