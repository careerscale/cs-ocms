...
<script src="resources/scripts/jquery/jquery-1.8.3.min.js" type="text/javascript"></script>
<script src="resources/scripts/jquery/jquery.validate.min.js" type="text/javascript"></script>

<script type="text/javascript" src="resources/scripts/jquery/jquery.maskedinput.js"></script>
<script type="text/javascript" src="resources/scripts/application/register.js"></script>
...
<div id="header-background">
        <div class="nav-global-container">
                <div class="login"><a href="#"><span></span>Login</a></div>
                <div class="logo"><a href="#"><img src="resources/images/logo_careerscale.gif" width="168" height="73"  alt="CareerScale" /></a>
 ...
 OCMS - Online Case Management System, The application connnecting the DOTS in the society!
	</div>
</div>
...
<div>
  <form id="profileForm" type="actionForm" action="step2.htm" method="get" >
    ...
    <div class="error" style="display:none;">
      <img src="resources/images/warning.gif" alt="Warning!" width="24" height="24" style="float:left; margin: -5px 10px 0px 0px; " />
...
<div id="col-left" class="nav-left-back empty resize" style="position: absolute; min-height: 450px;">
  ...
  <div class="nav-left">
      ...
      <div class="left-nav-callout png" style="top: 15px; margin-bottom: 100px;">
        <img src="resources/images/left-nav-callout-long.png"  class="png" alt="" />
        <h6>Sign Up Process</h6>
        <a style="background-image: url(resources/images/step1-24.gif); font-weight: normal; text-decoration: none; cursor: default;">Provide your basic information.</a>
        <a style="background-image: url(resources/images/step2-24.gif); font-weight: normal; text-decoration: none; cursor: default;">Chose the type of cases you are interested in.</a>
        <a style="background-image: url(resources/images/step3-24.gif); font-weight: normal; text-decoration: none; cursor: default;">Complete registration, validate your email/phone to get updates.</a>
      </div>

<div class="footerAddress">
<b>CareerScale IT Consulting LLP.</b><br />
2-1-7/2/88,Venkateswara Enclave.Upperpally<br />
Hyderabad, AP, 500048 INDIA<br />
</div>
<br clear="all"/>
</div>	<!-- end left col -->
