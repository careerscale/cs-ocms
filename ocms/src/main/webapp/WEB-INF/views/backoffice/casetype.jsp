...
<html><head>
		...
		<style type="text/css" media="screen">
			...
			@import "/resources/media/css/themes/smoothness/jquery-ui-1.7.2.custom.css";
			/*
		...
		<script src="/resources/media/js/jquery-1.4.4.min.js" type="text/javascript"></script>
        	<script src="/resources/media/js/jquery.dataTables.min.js" type="text/javascript"></script>
		<script type="text/javascript" src="/resources/media/js/jquery.dataTables.editable.js"></script>
		<script src="/resources/media/js/jquery.jeditable.js" type="text/javascript"></script>
        	<script src="/resources/media/js/jquery-ui.js" type="text/javascript"></script>
        	<script src="/resources/media/js/jquery.validate.js" type="text/javascript"></script>
...
<form id="formAddNewRow" action="#" title="Add a new browser" style="width:400px;min-width:300px"-->
<!--form:form method="post" action="#" id="caseTypeForm"
						modelAttribute="casetype"-->
						
        <label for="name">Case Type</label><br />
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
	...
	<tbody id="tbody1">
		...
		<c:forEach items = "${botypeList}" var="casetype">
          <tr id='${casetype.id}'>
             <td >${casetype.name}</td>
