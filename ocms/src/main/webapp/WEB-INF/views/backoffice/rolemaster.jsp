...
<h1>
    <spring:message code="view.backoffice.rolemaster.title" />
</h1>
    ...
    <div id="page-content-inner" class="resize">
        ...
        <div>
            ...
            <form:form method="post"
                action="/backoffice/rolemaster" id="backofficeForm"
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="label"><label for="roleName">Role Name:</label></td>
                        <td class="field"><form:input path="roleName" type="text"
                        ...
                        <td>
                            <div class="buttonSubmit">
                                <span></span> <input class="formButton" type="submit"
                                    value="Add Role Name" style="width: 150px" tabindex="3" />
                            </div>
