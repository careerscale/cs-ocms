...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		...
		$('#example').dataTable({
			...
			sUpdateURL : "updateOrgType",
            sDeleteURL: "delOrgType",  
			sAddURL : "addOrgType",
			sAddHttpMethod : "GET",
			...
			<div id="fw_content">
				...
				<div class="full_width">
					<form id="formAddNewRow" action="#" title="Add a new browser"
						...
						<label for="name">Organization Type</label><br /> <input
							type="text" name="name" id="name" class="required" rel="0" /> <br />
						<label for="description">Description</label><br /> <input
							type="text" name="description" id="browser" rel="1" />
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display"
						...
						<tbody id="tbody1">
							...
							<c:forEach items="${botypeList}" var="orgType">
								<tr id='${orgType.id}'>
									<td>${orgType.name}</td>
