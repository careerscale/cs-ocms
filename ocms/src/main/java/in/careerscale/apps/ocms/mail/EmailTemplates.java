...
public class EmailTemplates
{
	...
	private static String registrationTemplate = "Dear ${firstName}, \n Your  registration with "
			...
			+ "Password:  ${password} \n"
			+ "We need you verify your email address by clicking the following link \n"
			+ "${hostName}/verify?id=${idKey}&secret=${emailKey}"
			+ "\nThank you for registering with our site, Please verify your email address  and start using our website\n"
			+ "\nRegards, \n" + "${adminUser}\n" + "${productName}\n" + "${hostName}";
